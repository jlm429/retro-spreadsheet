if(NOT DEFINED RETRO_SPREADSHEET_APP OR NOT DEFINED RETRO_SPREADSHEET_UI_ARTIFACTS OR NOT DEFINED RETRO_SPREADSHEET_UI_ARGUMENT)
...
execute_process(
    COMMAND /usr/bin/open -W -n "${RETRO_SPREADSHEET_APP}" --args "${RETRO_SPREADSHEET_UI_ARGUMENT}"
    TIMEOUT 12
