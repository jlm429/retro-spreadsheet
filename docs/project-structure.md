...
- `.circleci/config.yml`: unattended Linux configure, portable-core build, and labeled core-test workflow. See the README test section for local UI smoke and end-to-end test availability.
