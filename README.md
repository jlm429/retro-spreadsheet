...
- editable `NSTableView` cells plus a raw-content `fx` formula bar where Return commits without moving the active cell, Tab commits and moves one column right, and Escape restores the original raw content
